...
import coders from "../../assets/certificates/100coders certificate .jpg";
  ...
  return (
    <section id="certificates">
      ...
      <div className="projectsBlocks">
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1PRQeuMVchNiaHWWhrbozfwzn_rxTRZEP"
            target="_blank"
        ...
        {/* 100coders certificate */}
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1dxgwAvxvch5zkRHzf48BLXNtaQW9TIH2"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
            {/* https://drive.google.com/file/d/1dxgwAvxvch5zkRHzf48BLXNtaQW9TIH2/view?usp=sharing */}
            <div>
              <img
                src={coders}
                alt="100 coders certificate"
                className="card__img"
              ></img>
              <span className="card__footer">
                <span>Finalist | 100coders 2023</span>
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1CDdYNNFJ0hu753g3MrFwfP-k8X4k2Z-A"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1RqnPaPeUN3zMWwOJ2BaqVLEzpNmNF96j"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
            ...
            <div>
              <img
                src={joy_of_programming}
                alt="joy_of_programming certificate"
                className="card__img"
              ></img>
              <span className="card__footer">
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1oXnw9YmtbD-wHOokS6_31IFZH65eCSuf"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1NqNT9_H6IpxWgxQo0D9gmGvpRsfvn9JD"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1b-5NHIucyK2guOh9dBWuRjifnJgbs0za"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1BY3Ow06gSyfTfX8AZTut12KtFRFn3SCx"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1YvOuJ9sxyFX9hcjYQpgYQX_VP_bhrPXq"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
        ...
        <div className="card">
          <a
            href="https://drive.google.com/uc?id=1MDw-gtVrJEuryJpbvyJ9yHHQDJPM5ZiA"
            target="_blank"
            rel="noopener noreferrer"
            role="button"
          >
      ...
      <a
        href="https://drive.google.com/drive/folders/1YSns-EeDuRiK4zzWZ-YSeke_adgq5ISD?usp=sharing"
        className="projectsBtn"
      >
        See my more Certificates
      </a>
    </section>
  );
};
